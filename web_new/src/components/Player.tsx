...
const DEFAULT_LIVE_OFFSET_MS = 0
...
const Player = () => {
    ...
    return (
        <div className="w-xl mx-auto bg-card rounded-xl shadow-lg overflow-hidden relative pointer-events-auto">
            {
                selectedStation &&
                <audio id="my-audio" crossOrigin="anonymous" ref={audioElementRef} src={`${BASE_URL}/buffered_mp3?sid=${selectedStation?.sid}&port=${selectedStation?.port}&offsetMs=${liveAudioOffsetMs}`} autoPlay>
                </audio>
            }
            ...
            <div className="p-5 space-y-4">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2 w-3/4 lg:w-1/2">
